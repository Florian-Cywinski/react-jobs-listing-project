...
const AddJobPage = ({ addJobSubmit }) => {  // addJobSubmit is a function passed in (to add a job) - see App.jsx
  ...
  const [title, setTitle] = useState('');   // Job Listing Name
  ...
  const navigate = useNavigate(); // To initialize useNavigate
  ...
  const submitForm = (e) => {
    ...
    const newJob = {
      ...
      description,
      salary,
      // Coz of the way the API is structured
      company: {
        name: companyName,
  ...
  return (
    <section className='bg-indigo-50'>  {/* Instead of class className */}
        ...
        <div className='bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0'>
          <form onSubmit={submitForm}>
            ...
            <div className='mb-4'>  
              ...
              {/* value={type} -> to connect a piece of state to a input -> an onChange is needed to update the value (e.target.value is whatever was selected / typed in) */}
              <select
                id='type'
                name='type'
